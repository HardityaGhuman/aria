...
- hr: like policy, but the query needs LIVE data from company HR/people systems (not the handbook) to answer — either (a) the CALLER'S OWN leave data: their remaining leave/PTO balance, how many days they have left, or their own leave record; or (b) the TEAM'S current out-of-office status: who is away, out, on leave, or on vacation right now, and until when. Signals: "how many leaves/PTO/days do I have left", "what's my balance", "how much leave have I used"; "who is out/away today/this week", "who is on leave/vacation", "is anyone off". A generic question about the leave POLICY (accrual rules, who is eligible, how carryover works) is still policy, not hr — hr is only when the answer needs live numbers or the live away-list, not a document rule.
...
- "who is out/away this week" / "who is on leave right now" / "is anyone off today" -> hr (needs the live team out-of-office list, not a document).
